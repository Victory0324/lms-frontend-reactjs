...
export const getDaysInWeek = function (s: any, v: any = 7) {
  let a = [],
    d = new Date(s)
  for (let i = 0; i < v; i++) {
    a.push(new Date(d))
...
export const getDayOfWeek = function (s: any) {
  const date = dayjs(s); // creates a new instance with the specified date
